...
module.exports = {
  entry: './source/js/blog/index.js',
  output: {
    filename: 'application.js',
    path: path.resolve(__dirname, 'blog/wp-content/themes/roverrobotics/assets/js')
  },
  plugins: [
    uglifyJs,
    provide,
  ...
  resolve: {
    alias: {
      ...
      'application.scss': path.resolve(__dirname, 'source/scss/blog/index.scss')
    },
    modules: [
